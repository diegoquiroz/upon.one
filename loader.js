    ...
    init:function(){
        ...
        window.addEventListener( "message",
          function (e) {
                ...
                if(e.origin !== 'https://upon.one' && e.origin !== 'http://upon.one' && e.origin !== null  && e.origin.indexOf('localhost') === -1 && e.origin !== 'http://www.upon.one' && e.origin !== 'https://www.upon.one'){ return; } 
                // alert(e.data);
